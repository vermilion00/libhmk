    ...
    if (__LL_ADC_IS_ENABLED_ALL_COMMON_INSTANCE(ADCxy_COMMON) == 0UL) {
        ...
        if (ADC_CommonInitStruct->Multimode != LL_ADC_MULTI_INDEPENDENT) {
            MODIFY_REG(ADCxy_COMMON->CCR,
                       ADC_CCR_ADCPRE | ADC_CCR_MULTI | ADC_CCR_DMA |
                           ADC_CCR_DDS | ADC_CCR_DELAY,
...
ErrorStatus LL_ADC_DeInit(ADC_TypeDef *ADCx) {
    ...
    if (READ_BIT(ADCx->CR2, ADC_CR2_ADON) == 0UL) {
        ...
        /* Reset register CR1 */
        CLEAR_BIT(ADCx->CR1, (ADC_CR1_OVRIE | ADC_CR1_RES | ADC_CR1_AWDEN |
                              ADC_CR1_JAWDEN | ADC_CR1_DISCNUM |
        ...
        CLEAR_BIT(ADCx->CR2,
                  (ADC_CR2_SWSTART | ADC_CR2_EXTEN | ADC_CR2_EXTSEL |
                   ...
                   ADC_CR2_ALIGN | ADC_CR2_EOCS | ADC_CR2_DDS | ADC_CR2_DMA |
        ...
        CLEAR_BIT(ADCx->SMPR2,
                  (ADC_SMPR2_SMP9 | ADC_SMPR2_SMP8 | ADC_SMPR2_SMP7 |
...
ErrorStatus LL_ADC_INJ_Init(ADC_TypeDef *ADCx,
    ...
    if (LL_ADC_IsEnabled(ADCx) == 0UL) {
        ...
        if (ADC_INJ_InitStruct->SequencerLength !=
            LL_ADC_REG_SEQ_SCAN_DISABLE) {
        ...
        /*       or function @ref LL_ADC_SetSequencersScanMode() ), */
        /*       this parameter is discarded. */
        LL_ADC_INJ_SetSequencerLength(ADCx,
