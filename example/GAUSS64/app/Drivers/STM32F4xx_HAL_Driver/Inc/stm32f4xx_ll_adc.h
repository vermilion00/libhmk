...
#define ADC_CHANNEL_ID_INTERNAL_CH_2                                           \
    0x40000000UL /* Marker of internal channel for other ADC instances, in     \
...
#define ADC_CHANNEL_DIFFERENCIATION_TEMPSENSOR_VBAT                            \
    0x10000000U /* Dummy bit for driver internal usage, not used in ADC        \
                   channel setting registers CR1 or SQRx */
...
#define TEMPSENSOR_CAL1_ADDR                                                   \
    ((uint16_t *)(0x1FFF7A2CU)) /* Internal temperature sensor, address of     \
                                   parameter TS_CAL1: On STM32F4, temperature  \
                                   sensor ADC raw data acquired at temperature \
                                   30 DegC (tolerance: +-5 DegC), Vref+ = 3.3  \
                                   V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR                                                   \
    ((uint16_t *)(0x1FFF7A2EU)) /* Internal temperature sensor, address of     \
                                   parameter TS_CAL2: On STM32F4, temperature  \
                                   sensor ADC raw data acquired at temperature \
                                   110 DegC (tolerance: +-5 DegC), Vref+ = 3.3 \
                                   V (tolerance: +-10 mV). */
...
typedef struct {
    ...
    uint32_t
        MultiDMATransfer; /*!< Set ADC multimode conversion data transfer: no
                             transfer or transfer by DMA. This parameter can be
                             a value of @ref ADC_LL_EC_MULTI_DMA_TRANSFER

                               This feature can be modified afterwards using
                             unitary function @ref LL_ADC_SetMultiDMATransfer().
                           */
...
typedef struct {
    uint32_t
        TriggerSource; /*!< Set ADC group regular conversion trigger source:
                          ...
                          external interrupt line). This parameter can be a
    ...
    uint32_t SequencerLength; /*!< Set ADC group regular sequencer length.
                                 ...
                                 ADC_LL_EC_REG_SEQ_SCAN_LENGTH
                                   @note This parameter is discarded if scan
                                 mode is disabled (refer to parameter
...
typedef struct {
    uint32_t
        TriggerSource; /*!< Set ADC group injected conversion trigger source:
                          ...
                          LL_ADC_INJ_StartConversionExtTrig().
                            ...
                            This feature can be modified afterwards using
                          unitary function @ref LL_ADC_INJ_SetTriggerSource().
                        */
    ...
    uint32_t
        TrigAuto; /*!< Set ADC group injected conversion trigger: independent or
                     from ADC group regular. This parameter can be a value of
                     @ref ADC_LL_EC_INJ_TRIG_AUTO Note: This parameter must be
                     set to set to independent trigger if injected trigger
...
#define LL_ADC_FLAG_EOCS_MST                                                   \
    ADC_CSR_EOC1 /*!< ADC flag ADC multimode master group regular end of       \
...
#define LL_ADC_FLAG_JEOS_MST                                                   \
    ADC_CSR_JEOC1 /*!< ADC flag ADC multimode master group injected end of     \
                     sequence conversions (Note: on this STM32 series, there   \
                     is no flag ADC group injected end of unitary conversion.  \
                     Flag noted as "JEOC" is corresponding to flag "JEOS" in   \
...
#define LL_ADC_FLAG_AWD1_MST                                                   \
    ADC_CSR_AWD1 /*!< ADC flag ADC multimode master analog watchdog 1 of the   \
                    ADC master */
...
#define LL_ADC_IT_JEOS                                                         \
    ADC_CR1_JEOCIE /*!< ADC interruption ADC group injected end of sequence    \
                      conversions (Note: on this STM32 series, there is no     \
                      flag ADC group injected end of unitary conversion. Flag  \
...
#define LL_ADC_PATH_INTERNAL_TEMPSENSOR                                        \
    (ADC_CCR_TSVREFE) /*!< ADC measurement path to internal channel            \
                         temperature sensor */
...
#define LL_ADC_DATA_ALIGN_LEFT                                                 \
    (ADC_CR2_ALIGN) /*!< ADC conversion data alignment: left aligned           \
...
#define LL_ADC_SEQ_SCAN_DISABLE                                                \
    0x00000000UL /*!< ADC conversion is performed in unitary conversion mode   \
                    ...
                    sequencers (sequence length, ...) is discarded: equivalent \
                    to length of 1 rank.*/
...
#define LL_ADC_CHANNEL_VREFINT                                                 \
    (LL_ADC_CHANNEL_17 |                                                       \
     ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to        \
                                    ...
                                    STM32F4, ADC channel available only on ADC \
                                    instance: ADC1. */
#define LL_ADC_CHANNEL_VBAT                                                    \
    (LL_ADC_CHANNEL_18 |                                                       \
     ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to        \
                                    ...
                                    below Vdda. On STM32F4, ADC channel        \
...
#define LL_ADC_CHANNEL_TEMPSENSOR                                              \
    (LL_ADC_CHANNEL_16 |                                                       \
     ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to        \
                                    Temperature sensor. On STM32F4, ADC        \
...
#define LL_ADC_REG_TRIG_EXT_TIM2_TRGO                                          \
    (ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_1 |                                     \
     ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger  \
                                       from external IP: TIM2 TRGO. Trigger    \
...
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO                                          \
    (ADC_CR2_EXTSEL_3 |                                                        \
     ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger  \
                                       from external IP: TIM3 TRGO. Trigger    \
                                       edge set to rising edge (default        \
                                       setting). */
...
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO                                          \
    (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_1 |                  \
     ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger  \
                                       from external IP: TIM8 TRGO. Trigger    \
                                       edge set to rising edge (default        \
                                       setting). */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                        \
    (ADC_CR2_EXTSEL_3 | ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_1 |                  \
     ...
     ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger  \
                                       ...
                                       line 11. Trigger edge set to rising     \
...
#define LL_ADC_REG_TRIG_EXT_RISING                                             \
    (ADC_CR2_EXTEN_0) /*!< ADC group regular conversion trigger polarity set   \
                         to rising edge */
#define LL_ADC_REG_TRIG_EXT_FALLING                                            \
    (ADC_CR2_EXTEN_1) /*!< ADC group regular conversion trigger polarity set   \
                         to falling edge */
...
#define LL_ADC_REG_CONV_CONTINUOUS                                             \
    (ADC_CR2_CONT) /*!< ADC conversions are performed in continuous mode:      \
...
#define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                      \
    (ADC_CR2_DDS |                                                             \
     ADC_CR2_DMA) /*!< ADC conversion data are transferred by DMA, in          \
...
#define LL_ADC_REG_SEQ_DISCONT_1RANK                                           \
    (ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode       \
...
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO                                          \
    (ADC_CR2_JEXTSEL_0 |                                                       \
     ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                       from external IP: TIM1 TRGO. Trigger    \
                                       edge set to rising edge (default        \
                                       setting). */
...
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO                                          \
    (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_0 |                                   \
     ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                       from external IP: TIM4 TRGO. Trigger    \
                                       edge set to rising edge (default        \
                                       setting). */
...
#define LL_ADC_INJ_TRIG_EXT_TIM5_TRGO                                          \
    (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_1 | ADC_CR2_JEXTSEL_0 |               \
     ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                       from external IP: TIM5 TRGO. Trigger    \
                                       edge set to rising edge (default        \
                                       setting). */
...
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                        \
    (ADC_CR2_JEXTSEL_3 | ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1 |               \
     ...
     ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger \
                                       from external IP: external interrupt    \
                                       line 15. Trigger edge set to rising     \
                                       edge (default setting). */
/**
 * @}
 */
...
#define LL_ADC_AWD_CHANNEL_0_REG                                               \
    ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external       \
...
#define LL_ADC_AWD_CH_VREFINT_REG                                              \
    ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |          \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal       \
...
#define LL_ADC_AWD_CH_TEMPSENSOR_REG                                           \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal       \
                        channel connected to Temperature sensor, converted by  \
                        group regular only. This internal channel is shared    \
...
#define LL_ADC_AWD_CH_TEMPSENSOR_INJ                                           \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal       \
                        channel connected to Temperature sensor, converted by  \
                        group injected only. This internal channel is shared   \
                        between temperature sensor and Vbat, only 1            \
                        measurement path must be enabled. */
#define LL_ADC_AWD_CH_TEMPSENSOR_REG_INJ                                       \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |      \
     ...
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal       \
                        channel connected to Temperature sensor, converted by  \
                        either group regular or injected. This internal        \
                        channel is shared between temperature sensor and Vbat, \
...
#define LL_ADC_MULTI_DUAL_REG_SIMULT                                           \
    (ADC_CCR_MULTI_2 | ADC_CCR_MULTI_1) /*!< ADC dual mode enabled: group      \
...
#define LL_ADC_MULTI_DUAL_INJ_SIMULT                                           \
    (ADC_CCR_MULTI_2 | ADC_CCR_MULTI_0) /*!< ADC dual mode enabled: group      \
...
#define LL_ADC_MULTI_TRIPLE_INJ_SIMULT                                         \
    (ADC_CCR_MULTI_4 | ADC_CCR_MULTI_2 |                                       \
     ADC_CCR_MULTI_0) /*!< ADC triple mode enabled: group injected             \
                         simultaneous */
...
#define LL_ADC_MULTI_REG_DMA_LIMIT_1                                           \
    (ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are           \
                       transferred by DMA, one DMA channel for all ADC         \
                       instances (DMA of ADC master), in limited mode (one     \
                       shot mode): DMA transfer requests are stopped when      \
                       number of DMA data transfers (number of ADC             \
                       conversions) is reached. This ADC mode is intended to   \
                       be used with DMA mode non-circular. Setting of DMA mode \
                       1: 2 or 3 (dual or triple mode) half-words one by one,  \
                       ADC1 then ADC2 then ADC3. */
#define LL_ADC_MULTI_REG_DMA_LIMIT_2                                           \
    (ADC_CCR_DMA_1) /*!< ADC multimode group regular conversions are           \
                       transferred by DMA, one DMA channel for all ADC         \
                       instances (DMA of ADC master), in limited mode (one     \
                       shot mode): DMA transfer requests are stopped when      \
                       number of DMA data transfers (number of ADC             \
                       conversions) is reached. This ADC mode is intended to   \
                       be used with DMA mode non-circular. Setting of DMA mode \
                       2: 2 or 3 (dual or triple mode) half-words one by one,  \
...
#define LL_ADC_MULTI_REG_DMA_LIMIT_3                                           \
    (ADC_CCR_DMA_1 |                                                           \
     ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are           \
                       ...
                       conversions) is reached. This ADC mode is intended to   \
                       be used with DMA mode non-circular. Setting of DMA mode \
                       3: 2 or 3 (dual or triple mode) bytes one by one,       \
                       ADC2&1 then ADC1&3 then ADC3&2. */
#define LL_ADC_MULTI_REG_DMA_UNLMT_1                                           \
    (ADC_CCR_DDS |                                                             \
     ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are           \
                       transferred by DMA, one DMA channel for all ADC         \
                       instances (DMA of ADC master), in unlimited mode: DMA   \
                       transfer requests are unlimited, whatever number of DMA \
                       data transferred (number of ADC conversions) is         \
                       reached. This ADC mode is intended to be used with DMA  \
                       mode non-circular. Setting of DMA mode 1: 2 or 3 (dual  \
                       or triple mode) half-words one by one, ADC1 then ADC2   \
                       then ADC3. */
#define LL_ADC_MULTI_REG_DMA_UNLMT_2                                           \
    (ADC_CCR_DDS |                                                             \
     ADC_CCR_DMA_1) /*!< ADC multimode group regular conversions are           \
                       ...
                       data transferred (number of ADC conversions) is         \
                       reached. This ADC mode is intended to be used with DMA  \
                       mode non-circular. Setting of DMA mode 2: 2 or 3 (dual  \
                       or triple mode) half-words by pairs, ADC2&1 then ADC1&3 \
                       then ADC3&2. */
#define LL_ADC_MULTI_REG_DMA_UNLMT_3                                           \
    (ADC_CCR_DDS | ADC_CCR_DMA_1 |                                             \
     ADC_CCR_DMA_0) /*!< ADC multimode group regular conversions are           \
                       ...
                       data transferred (number of ADC conversions) is         \
                       reached. This ADC mode is intended to be used with DMA  \
                       mode non-circular. Setting of DMA mode 3: 2 or 3 (dual  \
                       or triple mode) bytes one by one, ADC2&1 then ADC1&3    \
                       then ADC3&2. */
/**
 * @}
 */
...
#define __LL_ADC_MULTI_CONV_DATA_MASTER_SLAVE(__ADC_MULTI_MASTER_SLAVE__,      \
    ...
    (((__ADC_MULTI_CONV_DATA__) >>                                             \
      POSITION_VAL((__ADC_MULTI_MASTER_SLAVE__))) &                            \
     ADC_CDR_RDATA_MST)
#endif
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetTriggerSource(const ADC_TypeDef *ADCx) {
    uint32_t TriggerSource =
        READ_BIT(ADCx->CR2, ADC_CR2_EXTSEL | ADC_CR2_EXTEN);
