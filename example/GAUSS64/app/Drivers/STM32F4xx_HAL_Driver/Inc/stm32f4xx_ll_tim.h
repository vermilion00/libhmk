...
typedef struct {
    ...
    uint32_t
        Autoreload; /*!< Specifies the auto reload value to be loaded into the
...
typedef struct {
    ...
    uint8_t
        DeadTime; /*!< Specifies the delay time between the switching-off and
    ...
    uint16_t
        BreakState; /*!< Specifies whether the TIM Break input is enabled or
    ...
    uint32_t
        AutomaticOutput; /*!< Specifies whether the TIM Automatic Output feature
...
#define LL_TIM_TIM5_TI4_RMP_LSI                                                \
    (TIM_OR_TI4_RMP_0 | TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to  \
                                             LSI internal clock */
#define LL_TIM_TIM5_TI4_RMP_LSE                                                \
    (TIM_OR_TI4_RMP_1 |                                                        \
     TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to LSE */
#define LL_TIM_TIM5_TI4_RMP_RTC                                                \
    (TIM_OR_TI4_RMP | TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to    \
...
__STATIC_INLINE void LL_TIM_ConfigBRK(TIM_TypeDef *TIMx,
    ...
    /* Note: Any write operation to BKP bit takes a delay of 1 APB clock cycle
     * to become effective. */
    tmpreg = READ_REG(TIMx->BDTR);
    (void)(tmpreg);
}
