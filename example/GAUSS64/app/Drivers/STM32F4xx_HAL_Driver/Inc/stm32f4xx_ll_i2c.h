...
typedef struct {
    ...
    uint32_t
        ClockSpeed; /*!< Specifies the clock frequency.
                       ...
                       LL_I2C_SetDutyCycle() or @ref LL_I2C_SetClockSpeedMode()
    ...
    uint32_t DutyCycle; /*!< Specifies the I2C fast mode duty cycle.
                           ...
                           I2C_LL_EC_DUTYCYCLE
                             ...
                             This feature can be modified afterwards using
                           unitary function @ref LL_I2C_SetDutyCycle(). */
...
#define __LL_I2C_10BIT_HEADER_WRITE(__ADDRESS__)                               \
    ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((__ADDRESS__) &               \
                                                 (uint16_t)(0x0300))) >>       \
                                     7) |                                      \
                          (uint16_t)(0xF0))))
...
__STATIC_INLINE uint32_t LL_I2C_GetPeriphClock(I2C_TypeDef *I2Cx) {
    return (
        uint32_t)(__LL_I2C_FREQ_MHZ_TO_HZ(READ_BIT(I2Cx->CR2, I2C_CR2_FREQ)));
}
...
__STATIC_INLINE uint32_t LL_I2C_GetMode(I2C_TypeDef *I2Cx) {
    return (uint32_t)(READ_BIT(I2Cx->CR1, I2C_CR1_SMBUS | I2C_CR1_SMBTYPE |
                                              I2C_CR1_ENARP));
}
