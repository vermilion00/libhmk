...
#endif /* ADC2 || ADC3 */
                /* if no external trigger present enable software conversion of
                 * regular channels */
                if ((hadc->Instance->CR2 & ADC_CR2_EXTEN) == RESET) {
                    /* Enable the selected ADC software conversion for regular
                     * group */
...
HAL_StatusTypeDef HAL_ADC_ConfigChannel(ADC_HandleTypeDef *hadc,
    ...
    if ((hadc->Instance == ADC1) && (sConfig->Channel == ADC_CHANNEL_VBAT)) {
        /* Disable the TEMPSENSOR channel in case of using board with
         * multiplixed ADC_CHANNEL_VBAT & ADC_CHANNEL_TEMPSENSOR*/
